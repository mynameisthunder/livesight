...
class BaseNode: SCNNode {
    ...
    func addNode(with radius: CGFloat, and color: UIColor, and text: String) {
        ...
        ///rgb(4,120,225)
        let textC: UIColor = UIColor(red:CGFloat(4.0/255.0), green:CGFloat(120.0/255.0), blue:CGFloat(225.0/255.0), alpha:CGFloat(0.78))
        newText.firstMaterial?.diffuse.contents = textC
